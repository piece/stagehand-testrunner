h1. A continuous test runner for CLI
...
<pre><code class="json">{
    "require": {
        "piece/stagehand-testrunner": ">=3.0.0"
    }
}</code></pre>
...
<pre>pear channel-discover pear.piece-framework.com
...
Copyright (c) 2005-2012 KUBO Atsuhiro <kubo@iteman.jp>, 2007 Masahiko Sakamoto <msakamoto-sf@users.sourceforge.net>, 2010 KUMAKURA Yousuke <kumatch@gmail.com>, 2011 Shigenobu Nishikawa <shishi.s.n@gmail.com>, 2011 KUBO Noriko <noricott@gmail.com>, All rights reserved.
