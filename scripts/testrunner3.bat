...
IF EXIST ".\testrunner3" (
  %PHP_COMMAND% -d html_errors=off -d open_basedir= -q ".\testrunner3" %1 %2 %3 %4 %5 %6 %7 %8 %9
) ELSE (
  %PHP_COMMAND% -d html_errors=off -d open_basedir= -q "%SCRIPT_DIR%testrunner3" %1 %2 %3 %4 %5 %6 %7 %8 %9
)
GOTO CLEANUP
