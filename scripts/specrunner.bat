...
IF EXIST ".\specrunner" (
  %PHP_COMMAND% -d html_errors=off -d open_basedir= -q ".\specrunner" %1 %2 %3 %4 %5 %6 %7 %8 %9
) ELSE (
  %PHP_COMMAND% -d html_errors=off -d open_basedir= -q "%SCRIPT_DIR%specrunner" %1 %2 %3 %4 %5 %6 %7 %8 %9
)
GOTO CLEANUP
